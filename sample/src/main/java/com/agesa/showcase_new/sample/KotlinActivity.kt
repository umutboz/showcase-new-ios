...
import com.agesa.showcase_new.extras.backgrounds.FullscreenPromptBackground
import com.agesa.showcase_new.extras.backgrounds.RectanglePromptBackground
...
class KotlinActivity : AppCompatActivity() {
    ...
    fun showSideNavigationPrompt(view: View) {
        ...
        val tb = this.findViewById<Toolbar>(R.id.action_search)
